...
| M1 | 建立可复现的单卡训练、恢复与性能实验 | 本地完整验收通过 |
...
2. [环境搭建](getting-started/m0-m1-environment.md)：理解虚拟环境、CPU/GPU wheel、driver、CUDA runtime 和 `nvcc`。
...
7. [实验说明](../01_pytorch_training/experiments/README.md)：阅读全部成功与失败实验。
