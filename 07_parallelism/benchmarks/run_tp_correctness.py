"""Run 2/4-rank CPU/Gloo correctness for MLP and attention tensor parallelism."""
...
from trainscale_parallel.contract import load_local_config  # noqa: E402
...
def main() -> None:
    ...
    payload = build_artifact(
        artifact_type="module07.tp_local_correctness",
        repository_root=REPOSITORY_ROOT,
        environment={
        ...
        measurement={
            ...
            "reference": "unsharded MLP and self-attention",
            "checks": ["output", "gradient shard", "one-step parameter shard"],
        },
        status="success" if success else "failed",
        correctness={"status": "passed" if success else "failed"},
        metrics={"records": records},
        raw_artifacts=raw_artifacts,
        boundary="CPU/Gloo validates TP math and placements, not NCCL performance.",
    )
